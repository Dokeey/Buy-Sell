...
class CustomerCategory(models.Model):
    customer_category = models.CharField(verbose_name="카테고리 명", max_length=40)
...
class CustomerFAQ(models.Model):
    ...
    faq_category = models.ForeignKey(CustomerCategory, verbose_name="FAQ 카테고리", on_delete=models.CASCADE)
...
class CustomerAsk(models.Model):
    ...
    ask_category = models.ForeignKey(CustomerCategory, verbose_name="문의 카테고리", on_delete=models.CASCADE)
