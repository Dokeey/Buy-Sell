...
class OrderAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ['id', 'get_user_link', 'get_item_image', 'get_hit_count', 'email', 'username', 'phone',
                       'post_code', 'address', 'detail_address', 'requirement', 'get_sell_user_link', 'pay_choice',
                       'get_item_link', 'amount_html', 'status_html', 'updated_at', ]
    ...
    def get_fieldsets(self, request, obj=None):
        self.fieldsets = [
            ...
            (('구매자 정보'), {'fields': (
                'get_user_link', 'email', 'username', 'phone', 'post_code', 'address', 'detail_address',
                'requirement')}),
            (('결제 정보'), {'fields': ('pay_choice', 'amount_html', 'status_html', 'updated_at')}),
        ]
        if obj.pay_choice == 'import':
            field = (('이니페이 결제 정보'), {'fields': (
                'imp_uid', 'receipt_link', 'cancel_reason', 'fail_reason', 'paid_at', 'failed_at', 'cancelled_at')})
        else:
